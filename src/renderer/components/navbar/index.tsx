...
export function Navbar() {
  return (
    <nav className="fixed top-0 bg-neutral-50 dark:bg-neutral-800 w-full h-12 min-w-[400px] shadow-box dark:shadow-box-dark flex justify-between items-center px-5 transition-[background-color,box-shadow]  duration-500">
